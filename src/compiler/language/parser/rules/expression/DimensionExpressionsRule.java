...
public class DimensionExpressionsRule extends Rule
{
  ...
  private static final Production START_PRODUCTION = new Production(DIMENSION_EXPRESSION);
  private static final Production CONTINUATION_PRODUCTION = new Production(DIMENSION_EXPRESSIONS, DIMENSION_EXPRESSION);
