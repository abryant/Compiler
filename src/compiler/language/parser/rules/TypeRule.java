...
public class TypeRule extends Rule
{
  ...
  public TypeRule()
  {
    super(TYPE, CLOSURE_TYPE_PRODUCTION, PRIMITIVE_TYPE_PRODUCTION, POINTER_TYPE_PRODUCTION, TUPLE_TYPE_PRODUCTION, VOID_TYPE_PRODUCTION);
  }
  ...
  {
    if (types == CLOSURE_TYPE_PRODUCTION || types == PRIMITIVE_TYPE_PRODUCTION || types == POINTER_TYPE_PRODUCTION || types == TUPLE_TYPE_PRODUCTION || types == VOID_TYPE_PRODUCTION)
    {
