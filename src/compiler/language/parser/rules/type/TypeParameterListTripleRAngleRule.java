...
public class TypeParameterListTripleRAngleRule extends Rule
{
  ...
  private static final Production TYPE_PARAMETER_PRODUCTION      = new Production(TYPE_PARAMETER_TRIPLE_RANGLE);
  private static final Production TYPE_PARAMETER_LIST_PRODUCTION = new Production(TYPE_PARAMETER_NOT_QNAME_LIST, COMMA, TYPE_PARAMETER_LIST_TRIPLE_RANGLE);
  private static final Production QNAME_LIST_PRODUCTION          = new Production(QNAME,                         COMMA, TYPE_PARAMETER_LIST_TRIPLE_RANGLE);
  private static final Production NESTED_QNAME_LIST_PRODUCTION   = new Production(NESTED_QNAME_LIST,             COMMA, TYPE_PARAMETER_LIST_TRIPLE_RANGLE);
